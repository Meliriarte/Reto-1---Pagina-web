          ...
          <div className="bg-neutral-900 p-6 md:p-8 rounded-lg shadow-lg hover:shadow-beige/10 transition-all duration-500">
            <div className="prose prose-invert max-w-none">
              <p className="text-beige mb-4 hover:text-beige/90 transition-colors duration-300">
                ...
                crecer cada día. Amante de la tecnología, le gusta programar.
              </p>
              <p className="text-beige mb-4 hover:text-beige/90 transition-colors duration-300">
                En su tiempo libre, le encanta viajar en moto para descubrir pueblos, playas y
              ...
              <p className="text-beige hover:text-beige/90 transition-colors duration-300">
                Su sueño es tener su casa propia, formar una familia. La música relajante su refugio cuando necesita paz. Siempre busca aprender, crecer y
